...
fn load_public_encoded(
    ...
    key_id: &KeyId,
) -> Result<trussed_core::types::Bytes<{ crate::config::MAX_KEY_MATERIAL_LENGTH }>, Error> {
    ...
    fn serialize_key(
        ...
        match request.format {
            ...
            KeySerialization::Cose => {
                ...
                //   {1: 7, 3: -48, -1: <1312-byte public key>}
                ...
                //   03 38 2f  — key 3 = alg, value -48 = ML-DSA-44 (CBOR -1-47)
                //   20        — key -1 = pub
                //   59        — bstr, two-byte length follows
                const HEADER: [u8; 8] = [0xa3, 0x01, 0x07, 0x03, 0x38, 0x2f, 0x20, 0x59];
                serialized_key
