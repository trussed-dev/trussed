pub use trussed_core::types::{
    consent, reboot, CertId, CounterId, Id, KeyId, KeySerialization, Location, Mechanism,
    MediumData, Message, ObjectId, SerializedKey, ShortData, Signature, SignatureSerialization,
    SpecialId, StorageAttributes, UserAttribute,
};
